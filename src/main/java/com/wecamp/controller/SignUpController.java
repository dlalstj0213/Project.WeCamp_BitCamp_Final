...
public class SignUpController {
	...
	@RequestMapping(value = "sign_up_page.wcc") // Handler level
	// Handler level => 요청 url에 대해 해당 메서드에서 처리해야 되는 경우
	// “/sign_up/sign_up_page.wcc” 요청에 대한 처리를 signUpPage()에서 한다는 것을 의미한다.
	...
	@RequestMapping(value = "sign_up.wcc", method = RequestMethod.POST)
	...
	// 이메일 중복 체크
	@RequestMapping(value = "email_check.wcc", method = RequestMethod.POST)
	...
	// 회원 인증 
	@RequestMapping(value = "/approval_member.wcc", method = RequestMethod.POST)
