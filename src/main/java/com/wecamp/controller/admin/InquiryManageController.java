...
import com.wecamp.service.inquiryManage.InquiryManageService;
...
public class InquiryManageController {
	...
	@RequestMapping("inquiry_manage.wcc")
	private ModelAndView inquiryManage() {
		...
		response = new ModelAndView("admin/inquiry/inquiry_manage/"+WebTitle.TITLE+"업체 문의 관리");
		return response;
	}
