...
import static com.wecamp.setting.RefundSet.*;
...
//	RefundServiceImpl rfc = new RefundServiceImpl();
//	String token = rfc.getImportToken();
//	String amount = rfc.getAmount(token, "imp_524035720520");
//	rfc.cancelPayment(token, "imp_524035720520");
//	//int amount = Integer.parseInt(amountStr);
//	System.out.println(">>>imp_uid : "+"imp_163193808418");
//	System.out.println(">>>amount : "+amount);
//	 //new RefundController().cancelPayment(new RefundController().getImportToken(), "imp_163193808418");
//	}
