...
<%-- <input type="text" value="${list.pay_fee}">
<input type="text" value="${list.use_point}">
<input type="text" value="${list.save_point}"> --%>
		...
		<div class="card-item">
			...
			<a href="../search/camp_detail.wcc?camp_idx=${list.camp_idx}"
				...
				<div class="card-image">
					<!-- <img src="/images/camp-img/thumb/고성잔디캠핑장-thumb_209.jpg" class="card__img"
						style="height: 250px;"> -->
					<img src="/images/camp-img/thumb/${list.fname}" class="card__img"
						style="height: 250px;">
				</div>
			</a>
			...
			<div class="card-content-wrap">
				...
				<div class="rating-row">
									...
									<div class="modal-body">
										<article>
											<div class="container" role="main">
												...
												<form name="form" id="form${list.imp_uid}" method="post"
													...
													<div class="mb-3">
														...
														<div>
															<p id="star_grade${list.imp_uid}" class="star_grade"
																style="font-size: 20px;">
																<input type="hidden" value="${list.imp_uid}"> <a
																	href="">★</a> <input type="hidden"
																	value="${list.imp_uid}"> <a href="">★</a> <input
																	type="hidden" value="${list.imp_uid}"> <a
																	href="">★</a> <input type="hidden"
																	value="${list.imp_uid}"> <a href="">★</a> <input
																	type="hidden" value="${list.imp_uid}"> <a
																	href="">★</a> <input type="hidden"
					...
					<%-- <form method="post" id="form${list.imp_uid}" action="update_booking.wcc"> --%>
                    <!-- Modal -->
