            ...
            <div class="row">
                <div class="col-lg-12 position-relative">
                    <div class="breadcrumb-content">
                    	...
                    	<input type="hidden" name="address" id="address" value="서울 강남구 양재대로 333">
            ...
            <div class="col-lg-8">
                <div class="single-listing-wrap">
                    ...
                    <div class="feature-listing padding-bottom-20px">
						...
						<!-- end 카테고리 -->
							<!-- start card list -->
                        	<div class="card mb-3" onclick="selectSite(1)">
							...
							<div class="card mb-3" onclick="selectSite(2)">
						...
						<!-- end 카테고리 -->
							<div class="card mb-3" onclick="selectSite(3)">
							    ...
							    <div class="col-md-8">
							      <div class="card-body">
							        ...
							        <p class="card-text">
							        	...
							        	<br/>
							        	가격 : <strong id="price3">20000</strong> 원
							        </p>
							        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
							      </div>
							    </div>
            ...
            <div class="col-lg-4">
                <div class="sidebar section-bg">
                    ...
                    <div class="sidebar-widget date-widget">
                        <h3 id="bookingBox" class="widget-title">Booking</h3>
                        <div class="title-shape"></div>
                        <!-- start 선택된 캠핑 띄우기 -->
                            ...
                            <div class="recent-item mb-3">
                                ...
                                <div id="selectedBody" class="recentpost-body">
                                	<h4 class='recent__link'></h4>
                                		<p class='recent__meta'><span class='color-text font-weight-bold'>원하시는 캠핑장을 선택해주세요.</span></p>
                                </div><!-- end recent-img -->
                            </div><!-- end recent-item -->
                       ...
                       <div class="contact-form-action padding-top-35px">
                           <form>
                               <div class="form-group">
                                   ...
                                   <input id="startDate" class="date-range form-control calender-customize" type="text" name="daterange" value=""/>
                               </div>
                               <div class="form-group">
                                   <span class="la la-calendar-o form-icon"></span>
                                   <input id="endDate" class="date-range form-control calender-customize" type="text" name="daterange" value=""/>
                               </div>
                           </form>
                       </div>
                        <div class="booking-content d-flex align-items-center justify-content-between text-center">
                            <div class="input-number-group">
                                <p>People</p>
                                <div class="input-group-button" min="0">
                                    <span class="input-number-decrement" min="0">-</span>
                                </div>
                                <input id="peopleNum" class="input-number peopleNum" type="number" value="0" min="0" max="1">
                        ...
                        <div class="btn-box text-center padding-top-35px">
                             <div class="theme-btn d-block" onclick="setSessionAndSubmit()">예약하기</div>
                        </div><!-- end btn-box -->
                    </div><!-- end sidebar-widget -->
                </div><!-- end sidebar -->
            </div><!-- end col-lg-4 -->
