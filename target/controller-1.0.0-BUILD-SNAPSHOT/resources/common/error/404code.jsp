...
<!-- ================================
    START ERROR AREA
================================= -->
<section class="error-area padding-top-140px">
        ...
        <div class="row">
            <div class="col-lg-6 mx-auto">
                <div class="error-content text-center">
                    <img src="images/404-img.png" alt="error-image" class="w-100">
                   <div class="section-heading padding-top-30px">
                       <h1 class="sec__title pt-0 before-none">죄송합니다!</h1>
                       <p class="sec__desc">
                          <h3>원하시는 페이지를 찾을 수 없습니다.</h3>
						  WeCamp의 <a href="#" class="color-text">Help Center</a>에 문의해주세요!
                       </p>
                   </div>
                    <div class="or-box margin-top-30px margin-bottom-35px">
                        <span>or</span>
                    </div>
                    <div class="btn-box">
                        <a href="javascript:history.back();" class="theme-btn">
                            <span class="la la-mail-reply"></span> 이전페이지로
                        </a>
                    </div>
