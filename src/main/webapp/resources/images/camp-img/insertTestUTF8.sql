...
insert into CAMP values(CAMP_SEQ.nextval, 'linkdog애견캠핑장', 37.6605421, 127.489966, '경기도 가평군 설악면 신천중앙로28번길 101-60', '경기도 가평군 설악면 신천리 263-1', '000-0000-0000', 15, 60, 15, '전기시설,상하수도시설,샤워실,화장실', '소화기,대피소', '화장실,샤워실,개수대', '031-580-2066','가평군청 관광과');
insert into SORT values(SORT_SEQ.nextval, 1, '글램핑', '감자존-1', 4, 180000, '감자존1.jpg');
insert into SORT values(SORT_SEQ.nextval, 1, '글램핑', '감자존-2', 4, 180000, '감자존2.jpg');
insert into SORT values(SORT_SEQ.nextval, 1, '카라반', '시루존-1', 6, 220000, '시루존1.jpg');
