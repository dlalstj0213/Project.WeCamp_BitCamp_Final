						...
						<div class="logo-right-content" style="float: right !important">
							<div class="side-user-menu-open"
								...
								<span class="la la-user"
									style="color: white !important; width: 50px !important"></span>
							</div>
		...
		<div class="side-menu-wrap side-user-menu-wrap">
			...
			<ul class="side-menu-ul">
				<li><a href="dashboard.html"><span
						class="la la-user user-icon"></span> 회원정보</a></li>
				<li><a href="dashboard.html"><span
						class="la la-list-alt user-icon"></span> 예약내역</a></li>
				<li><a href="dashboard.html"><span
						class="la la-bookmark-o user-icon"></span> 찜 목록</a></li>
				<li><a href="dashboard.html"><span
						class="la la-plus-circle user-icon"></span> 업체등록</a></li>
